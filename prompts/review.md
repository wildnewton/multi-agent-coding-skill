...
5. Do not require required external-verification evidence to exist yet. Full Review certifies the current HEAD's code/tests/PR description before that verification runs.
