...
- **Executor (`run_codex.py`):** owns deterministic handoff/state/audit mechanics and returns exact accepted specialist/external-verification results to Coordinator.
