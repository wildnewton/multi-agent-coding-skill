...
- **Executor (`run_codex.py`):** owns deterministic handoff/state/audit mechanics and mechanical acceptance of your completed result, including required external-verification recording/guards.
