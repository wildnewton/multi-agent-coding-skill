...
The reported `test_command` must run the complete current RED set for this change, including any required integration coverage, not just tests added in the latest Testing iteration.
